...
var app = (function () {
    ...
    var auth = storage("auth", { user: null });

    // import { writable } from 'svelte/store';
    // export const matrixSessionId = writable(null);
    var app$1 = storage("app", { isChatterboxLoaded: false });
    ...
    class ChatButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { userId: 0, name: 1 });
    ...
    function create_fragment$2(ctx) {
    	...
    	chatbutton2 = new ChatButton({
    			props: {
    				name: "Jun Diep",
    				userId: "@jun.coder:matrix.org"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(chatbutton2.$$.fragment);
    			t2 = space();
    			a = element("a");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, div0);
    			mount_component(chatbutton0, div0, null);
    			append_dev(div0, t0);
    			mount_component(chatbutton1, div0, null);
    			append_dev(div0, t1);
    			mount_component(chatbutton2, div0, null);
    			append_dev(main, t2);
    			append_dev(main, a);
    			append_dev(main, t4);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(chatbutton0.$$.fragment, local);
    			transition_in(chatbutton1.$$.fragment, local);
    			transition_in(chatbutton2.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(chatbutton0.$$.fragment, local);
    			transition_out(chatbutton1.$$.fragment, local);
    			transition_out(chatbutton2.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block(ctx) {
    	...
    	route = new Route({
    			props: {
    				path: /*path*/ ctx[0],
    				component: /*RouteComponent*/ ctx[1]
    			},
    			$$inline: true
    		});
    ...
    function create_default_slot(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value = Object.entries(routes);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*Object, routes*/ 0) {
    				each_value = Object.entries(routes);
    				validate_each_argument(each_value);
    				let i;
