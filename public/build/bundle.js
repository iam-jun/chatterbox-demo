...
var app = (function () {
    ...
    const PUBLIC_CHAT_BASE_URL = "http://localhost:3000/#";
    ...
    const file$1 = "src/components/ChatButton.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 39, 0, 1045);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*openChatBox*/ ctx[1], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    class ChatButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { userId: 2, name: 3 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "btn-sign-out svelte-ph9e6i");
    			add_location(a, file, 34, 4, 988);
    			add_location(h1, file, 36, 8, 1094);
    			add_location(p, file, 37, 8, 1136);
    			attr_dev(img, "alt", "AGIL Logo");
    			attr_dev(img, "class", "logo svelte-ph9e6i");
    			...
    			add_location(img, file, 38, 8, 1200);
    			attr_dev(div, "class", "padding center svelte-ph9e6i");
    			add_location(div, file, 35, 4, 1057);
    			attr_dev(main, "class", "svelte-ph9e6i");
    			add_location(main, file, 33, 0, 977);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
